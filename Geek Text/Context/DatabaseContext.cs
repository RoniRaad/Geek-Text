    ...
    public class DatabaseContext
    {
        ...
        public async void SeedDatabase()
        {
            using (var connection = this.CreateConnection())
            {
                ...
                await connection.QueryAsync("INSERT INTO dbo.bookdetails(ISBN, Name, Description, Price,Author,Genre,Publisher, [Year Published], Sold) VALUES ('5267890', 'Cook', 'Test Description',9.99 , 1234, 'Horror' , 'Test Publisher' , '2010' , 10000);");
                await connection.QueryAsync("INSERT INTO dbo.bookdetails(ISBN, Name, Description, Price,Author,Genre,Publisher, [Year Published], Sold) VALUES ('5637890', 'Dook', 'Test Description',9.99 , 1234, 'Horror' , 'Test Publisher' , '2010' , 100000);");
                await connection.QueryAsync("INSERT INTO dbo.bookdetails(ISBN, Name, Description, Price,Author,Genre,Publisher, [Year Published], Sold) VALUES ('5567890', 'Eook', 'Test Description',9.99 , 1234, 'Horror' , 'Test Publisher' , '2010' , 1000000);");
                await connection.QueryAsync("INSERT INTO dbo.bookdetails(ISBN, Name, Description, Price,Author,Genre,Publisher, [Year Published], Sold) VALUES ('5667890', 'Fook', 'Test Description',9.99 , 1234, 'Horror' , 'Test Publisher' , '2010' , 1000000000);");
            }
        }
    }
}
